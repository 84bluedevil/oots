...
<div id="pageWrapper">
        ...
        <div data-tilt data-tilt-reverse="true" data-tilt-glare data-tilt-max-glare="0.2" data-tilt-scale="1.1" id="aboutUs" class="aboutUs" data-tilt>
            <header>
                <ul id="menu">
                    <li class="menuItem"><a class="navBtn" href="../pages/aboutme.html">Contact</a></li>
                    <li class="menuItem"><a class="navBtn" href="../index.html" >Home</a></li>
                    <li class="menuItem"><a class="navBtn" href="../pages/contact.html">Projects</a></li>
                    <li class="menuItem"><a class="navBtn" href="../pages/tracker.html">Tracker!</a></li>
                </ul>
            </header>
            <div id="paragraph" class="columnCenter">
                <h1 id="mHeading" class="centeredText">Thanks for you're input! I will reach out ASAP!</h1>
                <?php
                    $email = $_POST['email'];
